...
void test_qwen2(MockIC &mockIC) {
  ...
  for (int i = 0; i < 2; ++i) {
    ...
    mockIC.run_test(
        std::string(__func__)+": "+"new_chat " + std::to_string(i) + " - " + model, new_chat,
    ...
    mockIC.run_test(
        std::string(__func__)+": "+"run_update prompt step 1 for chat " + std::to_string(i) + " - " + model, run_update,
    ...
    mockIC.run_test(
        std::string(__func__)+": "+"run_update prompt step 2 for chat " + std::to_string(i) + " - " + model, run_update,
        "",
    ...
    mockIC.run_test(
        std::string(__func__)+": "+"run_update prompt step 3 for chat " + std::to_string(i) + " - " + model, run_update,
        "",
        "", silent_on_trap, my_principal);
    ...
    // -> can no longer check it, because the LLM generated tokens 
    mockIC.run_test(
        std::string(__func__)+": "+"run_update prompt step 4 for chat " + std::to_string(i) + " - " + model, run_update,
